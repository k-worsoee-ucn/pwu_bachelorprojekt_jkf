...
const salesData = [
  ...
  },
  {
    ...
    pressure: 1800,
    volumeFlow: 120000,
    description: "Custom cyclone separator for sawmill operations",
    customerId: 3,
    salesManagerId: 1,
    selectedFilters: [1, 3],
    selectedFans: [4],
  ...
  },
  {
    ...
    pressure: 1300,
    volumeFlow: 45000,
    description: "Grain dust collection and filtration",
    customerId: 4,
    salesManagerId: 2,
    selectedFilters: [2, 3],
    selectedFans: [5, 6],
  ...
  },
  {
    ...
    pressure: 2000,
    volumeFlow: 150000,
    description: "Complete HVAC and dust extraction solution",
    customerId: 5,
    salesManagerId: 1,
    selectedFilters: [1],
    selectedFans: [4, 6],
